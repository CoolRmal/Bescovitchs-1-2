...
private theorem s0s0_cross_le_reduced {E : Type*} [NormedAddCommGroup E]
    ...
    2 * (1 / 4 : ℝ) * ⟪p₁, w₁⟫_ℝ +
        ...
        2 * (7 / 60 : ℝ) * ⟪p₂, w₂⟫_ℝ ≤
      1 / 4 * ‖p₁‖ ^ 2 + 7 / 60 * ‖p₂‖ ^ 2 +
        3 / 25 * (‖p₁‖ ^ 2 + ‖p₂‖ ^ 2 - cStar ^ 2) +
        1 / 4 * ‖w₁‖ ^ 2 + 7 / 60 * ‖w₂‖ ^ 2 +
        3 / 25 * (‖w₁‖ ^ 2 + ‖w₂‖ ^ 2 - cStar ^ 2) := by
...
private theorem s0s0_pair_maximum :
    gramPairMaximum cStar (37 / 50) (71 / 150) (37 / 100) (71 / 300)
      ((cStar - 1) / 2) ((cStar + 1) / 2) (3 / 25) (10 / 27) ≤ 51 / 100 := by
...
private theorem s0s0_constant_neg :
    7679 / 1800 + 2 * (51 / 100) -
        14 / 15 * cStar * (2 * cStar - 1) + 2 * cStar - 3 * cStar ^ 2 < 0 := by
  rcases cStar_mem_isolation_box with ⟨hlower, hupper⟩
...
theorem gramCertificate_s0s0 {E : Type*} [NormedAddCommGroup E]
  ...
  have hp := gramPairCore_le_vertices e p₁ p₂ cStar
    (37 / 50) (71 / 150) (37 / 100) (71 / 300)
    ((cStar - 1) / 2) ((cStar + 1) / 2) (3 / 25) (10 / 27)
    he hp₁ hp₂ hpsep cStar_pos.le (by norm_num) (by norm_num) (by norm_num)
      (by norm_num) (by norm_num)
  have hw := gramPairCore_le_vertices e w₁ w₂ cStar
    (37 / 50) (71 / 150) (37 / 100) (71 / 300)
    ((cStar - 1) / 2) ((cStar + 1) / 2) (3 / 25) (10 / 27)
    he hw₁ hw₂ hwsep cStar_pos.le (by norm_num) (by norm_num) (by norm_num)
      (by norm_num) (by norm_num)
