...
public import Bescovitch.SixPoint.WeightedMixedCertificateData.Cap0Cap1NegNeg
...
theorem weightedMixedRootBoxBound_01NegNeg :
    WeightedMixedRootBoxBound false true (-1) (-1) :=
  weightedMixedRootBoxBound_of_tree_check false true (-1) (-1)
    weightedMixedTreeCap0Cap1SideNegSideNeg (by with_unfolding_all rfl)
