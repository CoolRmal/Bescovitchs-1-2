...
public import Bescovitch.SixPoint.WeightedMixedCertificateData.Cap0Cap0PosNeg
...
theorem weightedMixedRootBoxBound_00PosNeg :
    WeightedMixedRootBoxBound false false 1 (-1) :=
  weightedMixedRootBoxBound_of_tree_check false false 1 (-1)
    weightedMixedTreeCap0Cap0SidePosSideNeg (by with_unfolding_all rfl)
