...
public import Bescovitch.SixPoint.WeightedMixedCertificateData.Cap1Cap0PosPos
...
theorem weightedMixedRootBoxBound_10PosPos :
    WeightedMixedRootBoxBound true false 1 1 :=
  weightedMixedRootBoxBound_of_tree_check true false 1 1
    weightedMixedTreeCap1Cap0SidePosSidePos (by with_unfolding_all rfl)
