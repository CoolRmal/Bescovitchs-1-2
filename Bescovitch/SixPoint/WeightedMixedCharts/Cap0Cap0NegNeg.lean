...
public import Bescovitch.SixPoint.WeightedMixedCertificateData.Cap0Cap0NegNeg
...
theorem weightedMixedRootBoxBound_00NegNeg :
    WeightedMixedRootBoxBound false false (-1) (-1) :=
  weightedMixedRootBoxBound_of_tree_check false false (-1) (-1)
    weightedMixedTreeCap0Cap0SideNegSideNeg (by with_unfolding_all rfl)
